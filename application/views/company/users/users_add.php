    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class=" form">
                    <form class="form-horizontal " id="frmvalidate" enctype="multipart/form-data" method="post"  action="<?php echo site_url('companyusers/'.((!empty($id))?'edit':'add').'/'.$id); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo get_data('last_name')?>" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="username">Username</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="username" id="username"  autocomplete="off" required <?php if(!empty($id)){echo 'disabled  value="'.get_username_by_id($id).'"';}else{echo 'value="'.get_data('username').'"';} ?> onfocus="$('#username_warning').fadeIn(200)" onfocusout="$('#username_warning').fadeOut(200)">
                            </div>
                            <?php if(empty($id)){ ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="password" class="form-control" name="password" id="password" minlength="4" autocomplete="off" required <?php if(!empty($id)){echo 'disabled value="***********"';} ?>>
                                <div id="meter2"></div>
                            </div>
                            <?php if($id){?>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-right">
                                <button type="submit" name="submit" value="add"  class="btn btn-primary" > <?php echo (!$id)?'Save':'Update'; ?></button>         
                            </div>
                        </div>
                    </form>
                </div>
        ...
        $( "#frmvalidate" ).validate({
            ...
            'rules': {
                ...
                'email': {
                  ...
                  'email': true,
                  'remote': {
                        'url': "<?php echo base_url('companyusers/check_email')?>",
                        'type': "post",
                        'data': {
                          'email': function() {
                ...
                'username': {
                  'required': true,
                  'remote': "<?php echo base_url('companyusers/remote_username_check')?>"
                }
            },
            'messages': {
                'email': {
