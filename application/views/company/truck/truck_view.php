				...
				<div class="alert alert-success" id="success" style="display:none;"></div>
                    <form class="cmxform tasi-form" id="frmvalidate" enctype="multipart/form-data" method="post" action="<?php echo site_url('trucks/add/'.$id); ?>">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group ">
                                    ...
                                    <div class="form-control">
                                        <?php echo getDateFromDB($truck_detail['addition']);  ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 own" <?php echo ($truck_detail['owner_leased'] == 'Leased')?'style="display:block;"':'style="display:none;"'; ?> >
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group ">
                                    ...
                                    <div class="form-control">
                                        <?php echo getDateFromDB($truck_detail['annual_safety_due']);  ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                            <?php if($truck_detail['status'] != 'COMPANY'){?>
                            <label for="contract_due" class="control-label">Contract Due</label>
                                <div class="form-control">
                                    <?php if($truck_detail['contract_due'] != null){ 
                                        
                                                echo getDateFromDB($truck_detail['contract_due']);
                                        } ?>
                                </div>
                            <?php } ?>
                            </div>
