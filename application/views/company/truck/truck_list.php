    ...
    <div class="col-lg-12">
        <section  class="panel" id="advanced_search">
            <div class="panel-body">
                <h4 class=""> <strong>Trucks List</strong>
                <a href="<?php echo site_url('trucks/add')?>" class="btn btn-primary fa fa-plus pull-right" > Add New Truck</a>
                <button type="button" class="btn btn-success fa fa-file-excel-o pull-right" id="excel_file_import"  data-toggle="popover" title="Import Excel File <i class='fa fa-times pull-right popover_close' id='excel_file_import_close' title='Close'></i>" data-content="<form action='<?php echo base_url().'trucks/import'?>' method='post' enctype='multipart/form-data' class='form-inline'><div class='form-group mb-2'> <input type='file' class='form-control' name='excel_file' required></div><div class='form-group mx-sm-3 mb-2'> <input type='submit' class='btn btn-sm btn-info pull-right fa fa-clone' style='margin-left: 10px;' name='submit'></div></form><div class='text-danger' style='margin-top: 7px;font-size: 11px;'><a href='<?php echo base_url();?>uploads/excel_files/samples/Truck_sample.xlsx'>Download a sample of Excel</a></div>" data-placement="bottom"> Import Truck</button></h4>
                <hr style="margin:5px0px;" />
                <form id="user_search">
                    <div class="col-md-5">
                        <label>Truck State</label>
                        <hr style="margin:5px 0px;" />
                        <input checked="checked" onchange="datatableData($(this).val())" name="user_search_type" id="user_search_type1" value="0" type="radio"  /><label for="user_search_type1">&nbsp;Active Truck&nbsp;</label>(<?php echo $active; ?>)&nbsp;&nbsp;&nbsp;
                        <input onchange="datatableData($(this).val())" name="user_search_type" id="user_search_type2" value="1" type="radio"  /><label for="user_search_type2">&nbsp;Inactive Truck&nbsp;</label>(<?php echo $deactive; ?>)&nbsp;&nbsp;&nbsp;
                        <input onchange="datatableData($(this).val())" name="user_search_type" id="user_search_type3" value="all" type="radio"  /><label for="user_search_type3">&nbsp;ALL Truck&nbsp;</label>(<?php echo $all; ?>)&nbsp;&nbsp;&nbsp;
                    </div>
                </form>
            </div>
        </section>
