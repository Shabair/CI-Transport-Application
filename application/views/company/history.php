...
var table =	$('#mv_datatable').DataTable( {
        ...
        "bPaginate": true,
        "responsive": true,
		"ajax": "<?=base_url('history/datatable_json')?>",
		"order": [[6,'desc']],
		"columnDefs": [
			...
			{ "targets": 5, "name": "CONCAT(d.first_name,' ',d.middle_name,' ',d.last_name)", 'searchable':true, 'orderable':true},
...
{
	$.post('<?=base_url('history/search')?>',$('#user_search').serialize(),function(){
