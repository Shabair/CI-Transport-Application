...
<style type="text/css">
  ...
  #DataTables_Table_0 td:nth-child(1),#DataTables_Table_0 td:nth-child(4),#DataTables_Table_0 td:last-child{
      text-align: center;
              ...
              <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse1">
                  ...
                  <div class="pull-right">
                    ...
                    <a class="btn btn-xs btn-info" href="<?php echo base_url('drug/edit/'.$fupQuery['id'])?>"> <i class="fa fa-pencil-square-o"></i></a>
...
<?php endif;//end of sap of ?>
    ...
    <div class="quarter-container col-lg-2">
