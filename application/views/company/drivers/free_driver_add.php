...
<?php 
    ...
    if(isset($driver['id'])){
        $form_target = "driver/add_driver/{$driver['id']}";
    }else{
...
if(isset($driver['id'])){
    ...
    if(!set_value('submit')):
        ...
        for($i =1 ;$i <= $driver['prv_add_no'] ; $i++){
            $driver['previous_address_'.$i]     = isset($previous_address[$i-1])?$previous_address[$i-1]:'';
            $driver['previous_street_'.$i]      = isset($previous_street[$i-1])?$previous_street[$i-1]:'';
            $driver['previous_city_'.$i]        = isset($previous_city[$i-1])?$previous_city[$i-1]:'';
            $driver['previous_province_'.$i]    = isset($previous_province[$i-1])?$previous_province[$i-1]:'';
            $driver['previous_postal_code_'.$i] = isset($previous_postal_code[$i-1])?$previous_postal_code[$i-1]:'';
            $driver['previous_duration_'.$i]    = isset($previous_duration[$i-1])?$previous_duration[$i-1]:'';
        }
    endif;
    ...
    if(!set_value('submit')):
        ...
        for($i =1 ;$i <= $driver['prv_empl_his_no'] ; $i++){
            ...
            $driver['is_employed'.$i]              = isset($is_employed[$i-1])?$is_employed[$i-1]:'';
            $driver['fax_no'.$i]                   = isset($fax_no[$i-1])?$fax_no[$i-1]:'';
            $driver['employer_email'.$i]           = isset($employer_email[$i-1])?$employer_email[$i-1]:'';
            $driver['employer_company_name'.$i]    = isset($employer_company_name[$i-1])?$employer_company_name[$i-1]:'';
            $driver['employer_name'.$i]            = isset($employer_name[$i-1])?$employer_name[$i-1]:'';
            $driver['employer_address'.$i]         = isset($employer_address[$i-1])?$employer_address[$i-1]:'';
            $driver['employer_number'.$i]          = isset($employer_number[$i-1])?$employer_number[$i-1]:'';
            $driver['employer_city'.$i]            = isset($employer_city[$i-1])?$employer_city[$i-1]:'';
            $driver['employer_province'.$i]        = isset($employer_province[$i-1])?$employer_province[$i-1]:'';
            $driver['emplyer_zip'.$i]              = isset($emplyer_zip[$i-1])?$emplyer_zip[$i-1]:'';
            $driver['position_held'.$i]            = isset($position_held[$i-1])?$position_held[$i-1]:'';
            $driver['position_held_other'.$i]      = isset($position_held_other[$i-1])?$position_held_other[$i-1]:'';
            $driver['salary_wage'.$i]              = isset($salary_wage[$i-1])?$salary_wage[$i-1]:'';
            $driver['employment_fron_date'.$i]     = isset($employment_fron_date[$i-1])?$employment_fron_date[$i-1]:'';
            $driver['employment_to_date'.$i]       = isset($employment_to_date[$i-1])?$employment_to_date[$i-1]:'';
            $driver['employer_leaving_reason'.$i]  = isset($employer_leaving_reason[$i-1])?$employer_leaving_reason[$i-1]:'';
            $driver['fmcsr_status'.$i]             = isset($fmcsr_status[$i-1])?$fmcsr_status[$i-1]:'';
            $driver['safety_sensitive_status'.$i]  = isset($safety_sensitive_status[$i-1])?$safety_sensitive_status[$i-1]:'';
        }
    ...
    if(!set_value('submit')):
        ...
        for($i =1 ;$i <= $driver['prv_acc_his_no'] ; $i++){
            $driver['accident_date_'.$i]  = isset($accident_date[$i-1])?$accident_date[$i-1]:'';
            $driver['accident_nature_'.$i]  = isset($accident_nature[$i-1])?$accident_nature[$i-1]:'';
            $driver['accident_fatalities_'.$i]  = isset($accident_fatalities[$i-1])?$accident_fatalities[$i-1]:'';
            $driver['accident_injuries_'.$i]  = isset($accident_injuries[$i-1])?$accident_injuries[$i-1]:'';
            $driver['accident_hazardous_'.$i]  = isset($accident_hazardous[$i-1])?$accident_hazardous[$i-1]:'';
        }
    ...
    if(!set_value('submit')):
        ...
        for($i =1 ;$i <= $driver['prv_traffic_conviv_no'] ; $i++){
            $driver['traf_conviv_date_'.$i]  = isset($traf_conviv_date[$i-1])?$traf_conviv_date[$i-1]:'';
            $driver['traf_conviv_loc_'.$i]  = isset($traf_conviv_loc[$i-1])?$traf_conviv_loc[$i-1]:'';
            $driver['traf_conviv_chrg_'.$i]  = isset($traf_conviv_chrg[$i-1])?$traf_conviv_chrg[$i-1]:'';
            $driver['traf_conviv_pen_'.$i]  = isset($traf_conviv_pen[$i-1])?$traf_conviv_pen[$i-1]:'';
        }
    ...
    // var_dump($driver['emp_drug_test_status_yn']);
        ...
        for($i =1 ;$i <= $driver['emp_drug_test_his_no'] ; $i++){
            $driver['emp_drug_test_type_'.$i]  = isset($emp_drug_test_type[$i-1])?$emp_drug_test_type[$i-1]:'';
            $driver['emp_drug_test_date_'.$i]  = isset($emp_drug_test_date[$i-1])?$emp_drug_test_date[$i-1]:'';
            $driver['emp_drug_test_status_yn_'.$i]  = isset($emp_drug_test_status_yn[$i-1])?$emp_drug_test_status_yn[$i-1]:'';
        }
    endif;
    ...
    if(!set_value('submit')):
        ...
        for($i =1 ;$i <= 7 ; $i++){
            $driver['status_de'.$i]     = isset($status_de[$i-1])?$status_de[$i-1]:'';
            $driver['type_de'.$i]       = isset($type_de[$i-1])?$type_de[$i-1]:'';
            $driver['from_de'.$i]       = isset($from_de[$i-1])?$from_de[$i-1]:'';
            $driver['to_de'.$i]         = isset($to_de[$i-1])?$to_de[$i-1]:'';
            $driver['miles_de'.$i]      = isset($miles_de[$i-1])?$miles_de[$i-1]:'';
        }
    ...
    for($i =1 ;$i <= 14 ; $i++){
        $driver['hours_worked_'.$i]     = (isset($hours_worked[$i-1]))?$hours_worked[$i-1]:'';
        $driver['work_date_'.$i]     = (isset($work_date[$i-1]))?$work_date[$i-1]:'';
    }

    set_data($driver);
// echo get_data('get_data('prv_acc_his_no')');
    // var_dump(get_data('status_de'));
    // echo get_data('prv_acc_his_no');
    // die();  
}else{
        $id='';
}
...
// echo $driver['willing_status_rdo'];
// die();
                    ...
                    <div class="tab-content">
                        ...
                        <div id="w6-profile" class="tab-pane active">
                        	<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<select class="form-control" name="position_applied" id="w6-position_applied" required>
                                        ...
                                        <option value="local" <?php echo (get_data('position_applied') == 'local')?'Selected':'';?> >City Driver</option>
                                        <option value="long_haul" <?php echo (get_data('position_applied') == 'long_haul')?'Selected':'';?> >long haul</option>
                                        <option value="owner_operator" <?php echo (get_data('position_applied') == 'owner_operator')?'Selected':'';?> >Owner Operator</option>
                                        <option value="driver_of_owner" <?php echo (get_data('position_applied') == 'driver_of_owner')?'Selected':'';?> >Driver Of Owner Operator</option>
                                    </select>
                            	</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" id="w6-cvor_date" value="<?php echo get_data('cvor_date');?>" name="cvor_date" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="passport_yes" name="passport" type="radio" <?php echo (get_data('passport') == 'Yes')?'checked':'';?> value="Yes" required="" class="valid">
                                        <label for="w6-road_test">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="passport_no" name="passport" type="radio" <?php echo (get_data('passport') == 'No')?'checked':'';?> value="No" class="valid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="road_test_yes" name="road_test" type="radio" <?php echo (get_data('road_test') == 'Yes')?'checked':'';?> value="Yes" required="" class="valid">
                                        <label for="w6-road_test">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="road_test_no" name="road_test" type="radio" <?php echo (get_data('road_test') == 'No')?'checked':'';?> value="No" class="valid">
                                        <label for="w6-road_testo">No</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-1">
                                    <div class="radio-custom radio-info">
                                        <input id="police_report_yes" name="police_report" type="radio" <?php echo (get_data('police_report') == 'Yes')?'checked':'';?> value="Yes" required="" class="valid">
                                        <label for="legal_right_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="police_report_no" name="police_report" type="radio" <?php echo (get_data('police_report') == 'No')?'checked':'';?> value="No" class="valid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="email" id="w6-email" value="<?php echo get_data('email');?>" autocomplete="off">
                                </div>
                                <label class="col-sm-2 control-label" for="w6-sin">Social Security Number</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control ss_no" name="sin" id="w6-sin" value="<?php echo get_data('sin');?>" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="emp_license_state" id="w6-emp_license_state" required>
                                        ...
                                        <option value="AB" <?php echo (get_data('emp_license_state')=='AB')?'Selected':'';?> >Alberta</option>
                                        <option value="BC" <?php echo (get_data('emp_license_state')=='BC')?'Selected':'';?> >British Columbia</option>
                                        <option value="MB" <?php echo (get_data('emp_license_state')=='MB')?'Selected':'';?> >Manitoba</option>
                                        <option value="NB" <?php echo (get_data('emp_license_state')=='NB')?'Selected':'';?> >New Brunswick</option>
                                        <option value="NL" <?php echo (get_data('emp_license_state')=='NL')?'Selected':'';?> >Newfoundland and Labrador</option>
                                        <option value="NT" <?php echo (get_data('emp_license_state')=='NT')?'Selected':'';?> >Northwest Territories</option>
                                        <option value="NS" <?php echo (get_data('emp_license_state')=='NS')?'Selected':'';?> >Nova Scotia</option>
                                        <option value="NU" <?php echo (get_data('emp_license_state')=='NU')?'Selected':'';?> >Nunavut</option>
                                        <option value="ON" <?php echo (get_data('emp_license_state')=='ON')?'Selected':'';?> >Ontario</option>
                                        <option value="PE" <?php echo (get_data('emp_license_state')=='PE')?'Selected':'';?> >Prince Edward Island</option>
                                        <option value="QC" <?php echo (get_data('emp_license_state')=='QC')?'Selected':'';?> >Quebec</option>
                                        <option value="SK" <?php echo (get_data('emp_license_state')=='SK')?'Selected':'';?> >Saskatchewan</option>
                                        <option value="YT" <?php echo (get_data('emp_license_state')=='YT')?'Selected':'';?> >Yukon Territory</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('emp_license_org_date');?>" id="emp_license_org_date" name="emp_license_org_date" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" id="emp_license_exp_date" value="<?php echo date("m/d/Y",strtotime(get_data('emp_license_exp_date')));?>" name="emp_license_exp_date" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="emp_license_class" id="w6-emp_license_class" required>
                                        ...
                                        <option value="C-Class" <?php echo (get_data('emp_license_class') == 'C-Class')?'Selected':'';?> >C-Class</option>
                                        <option value="AZ" <?php echo (get_data('emp_license_class') == 'AZ')?'Selected':'';?> >AZ</option>
                                        <option value="DZ" <?php echo (get_data('emp_license_class') == 'DZ')?'Selected':'';?> >DZ</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="current_province" id="w6-current_province" required>
                                        <option value="">Select State</option>
                                        <option value="AB" <?php echo (get_data('current_province')=='AB')?'Selected':'';?> >Alberta</option>
                                        <option value="BC" <?php echo (get_data('current_province')=='BC')?'Selected':'';?> >British Columbia</option>
                                        <option value="MB" <?php echo (get_data('current_province')=='MB')?'Selected':'';?> >Manitoba</option>
                                        <option value="NB" <?php echo (get_data('current_province')=='NB')?'Selected':'';?> >New Brunswick</option>
                                        <option value="NL" <?php echo (get_data('current_province')=='NL')?'Selected':'';?> >Newfoundland and Labrador</option>
                                        <option value="NT" <?php echo (get_data('current_province')=='NT')?'Selected':'';?> >Northwest Territories</option>
                                        <option value="NS" <?php echo (get_data('current_province')=='NS')?'Selected':'';?> >Nova Scotia</option>
                                        <option value="NU" <?php echo (get_data('current_province')=='NU')?'Selected':'';?> >Nunavut</option>
                                        <option value="ON" <?php echo (get_data('current_province')=='ON')?'Selected':'';?> >Ontario</option>
                                        <option value="PE" <?php echo (get_data('current_province')=='PE')?'Selected':'';?> >Prince Edward Island</option>
                                        <option value="QC" <?php echo (get_data('current_province')=='QC')?'Selected':'';?> >Quebec</option>
                                        <option value="SK" <?php echo (get_data('current_province')=='SK')?'Selected':'';?> >Saskatchewan</option>
                                        <option value="YT" <?php echo (get_data('current_province')=='YT')?'Selected':'';?> >Yukon Territory</option>
                                	</select>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div id="w6-application" class="tab-pane ">
                        	...
                        	<div class="form-group">
                            	<label class="col-sm-2 control-label" for="w6-emg_contact">Emergency Contact Name &amp; relationship</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="emg_contact" value="<?php echo get_data('emg_contact');?>" id="w6-emergency_relation" autocomplete="off">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control default-date-picker" id="w6-medical_due" value="<?php echo date("m/d/Y",strtotime(get_data('medical_due')));?>" name="medical_due" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="defensive_driving_yes" name="defensive_driving" type="radio" <?php echo (get_data('defensive_driving')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="defensive_driving_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="defensive_driving_no" name="defensive_driving" type="radio" <?php echo (get_data('defensive_driving')=='No')?'checked':''?> value="No">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="road_evalution_yes" name="road_evalution" type="radio" <?php echo (get_data('road_evalution')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="road_evalution_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="road_evalution_no" name="road_evalution" type="radio" <?php echo (get_data('road_evalution')=='No')?'checked':''?> value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="province_insurance_yes" name="province_insurance" type="radio" <?php echo (get_data('province_insurance')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="province_insurance_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="province_insurance_no" name="province_insurance" type="radio" <?php echo (get_data('province_insurance')=='No')?'checked':''?> value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="legal_right_yes" name="legal_right" type="radio"  <?php echo (get_data('legal_right')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="legal_right_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="legal_right_no" name="legal_right" type="radio" <?php echo (get_data('legal_right')=='No')?'checked':''?> value="No">
                                        <label for="legal_right_no">No</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" id="dob" value="<?php echo get_data('dob');?>" name="dob" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="provide_age_proof_yes" name="provide_age_proof" <?php echo (get_data('provide_age_proof')=='Yes')?'checked':''?> type="radio" value="Yes" required="">
                                        <label for="provide_age_proof_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="provide_age_proof_no" name="provide_age_proof" <?php echo (get_data('provide_age_proof')=='No')?'checked':''?> type="radio" value="No">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="worked_before_yes" name="worked_before" <?php echo (get_data('worked_before')=='Yes')?'checked':''?> type="radio" value="Yes" required="">
                                        <label for="worked_before_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="worked_before" name="worked_before" <?php echo (get_data('worked_before')=='No')?'checked':''?> type="radio" value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="employment_status_yes" name="employment_status" <?php echo (get_data('employment_status')=='Yes')?'checked':''?> type="radio" value="Yes" required="">
                                        <label for="employment_status_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="employment_status_no" name="employment_status" <?php echo (get_data('employment_status')=='No')?'checked':''?> type="radio" value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="bond_yes" name="bond_status" type="radio" <?php echo (get_data('bond_status')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="bond_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="bond_no" name="bond_status" type="radio" <?php echo (get_data('bond_status')=='No')?'checked':''?> value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="felony_yes" name="felony_status" <?php echo (get_data('felony_status')=='Yes')?'checked':''?> type="radio" value="Yes" required="">
                                        <label for="felony_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="felony_no" name="felony_status" <?php echo (get_data('felony_status')=='No')?'checked':''?> type="radio" value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="performance_status_yes" name="performance_status" <?php echo (get_data('performance_status')=='Yes')?'checked':''?> type="radio" value="Yes" required="">
                                        <label for="performance_status_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="performance_status_no" name="performance_status" <?php echo (get_data('performance_status')=='No')?'checked':''?> type="radio" value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="radio-custom radio-info">
                                        <input id="fast_driver_status_yes" name="fast_driver_status" type="radio" <?php echo (get_data('fast_driver_status')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="fast_driver_status_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="fast_driver_status_no" name="fast_driver_status" type="radio" <?php echo (get_data('fast_driver_status')=='No')?'checked':''?> value="No">
                        ...
                        <div id="w6-drv_exp" class="tab-pane">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="emp_highest_grade" id="w6-emp_highest_grade" required>
                                        ...
                                        <option value="1" <?php echo (get_data('emp_highest_grade') == '1')?'Selected':'';?> >1</option>
                                        <option value="2" <?php echo (get_data('emp_highest_grade') == '2')?'Selected':'';?> >2</option>
                                        <option value="3" <?php echo (get_data('emp_highest_grade') == '3')?'Selected':'';?> >3</option>
                                        <option value="4" <?php echo (get_data('emp_highest_grade') == '4')?'Selected':'';?> >4</option>
                                        <option value="5" <?php echo (get_data('emp_highest_grade') == '5')?'Selected':'';?> >5</option>
                                        <option value="6" <?php echo (get_data('emp_highest_grade') == '6')?'Selected':'';?> >6</option>
                                        <option value="7" <?php echo (get_data('emp_highest_grade') == '7')?'Selected':'';?> >7</option>
                                        <option value="8" <?php echo (get_data('emp_highest_grade') == '8')?'Selected':'';?> >8</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="emp_high_school" id="w6-emp_high_school" required>
                                        ...
                                        <option value="1" <?php echo (get_data('emp_high_school') == '1')?'Selected':'';?> >1</option>
                                        <option value="2" <?php echo (get_data('emp_high_school') == '2')?'Selected':'';?> >2</option>
                                        <option value="3" <?php echo (get_data('emp_high_school') == '3')?'Selected':'';?> >3</option>
                                        <option value="4" <?php echo (get_data('emp_high_school') == '4')?'Selected':'';?> >4</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="emp_college" id="w6-emp_college" required>
                                        ...
                                        <option value="1" <?php echo (get_data('emp_college') == '1')?'Selected':'';?> >1</option>
                                        <option value="2" <?php echo (get_data('emp_college') == '2')?'Selected':'';?> >2</option>
                                        <option value="3" <?php echo (get_data('emp_college') == '3')?'Selected':'';?> >3</option>
                                        <option value="4" <?php echo (get_data('emp_college') == '4')?'Selected':'';?> >4</option>
                                    </select>
                                </div>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed mb-none">
                                            ...
                                            <tbody>
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de1" class="de" name="status_de1" <?php echo (get_data('status_de1')=='Yes')?'checked':''?>  type="radio" value="Yes" required="">
                                                                    <label for="status_de1">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de1" class="de" name="status_de1" <?php echo (get_data('status_de1')=='No')?'checked':''?> type="radio" value="No">
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de2" class="de" name="status_de2" type="radio" <?php echo (get_data('status_de2')=='Yes')?'checked':''?> value="Yes" required="">
                                                                    <label for="status_de2">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de2" class="de" name="status_de2" type="radio" <?php echo (get_data('status_de2')=='No')?'checked':''?> value="No">
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de3" class="de" name="status_de3" type="radio" <?php echo (get_data('status_de3')=='Yes')?'checked':''?> value="Yes" required="">
                                                                    <label for="status_de3">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de3" class="de" name="status_de3" type="radio" <?php echo (get_data('status_de3')=='No')?'checked':''?> value="No">
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de4" class="de" name="status_de4" type="radio" <?php echo (get_data('status_de4')=='Yes')?'checked':''?> value="Yes" required="">
                                                                    <label for="status_de4">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de4" class="de" name="status_de4" type="radio" <?php echo (get_data('status_de4')=='No')?'checked':''?> value="No">
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de5" class="de" name="status_de5" type="radio" <?php echo (get_data('status_de5')=='Yes')?'checked':''?> value="Yes" required="">
                                                                    <label for="status_de5">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de5" class="de" name="status_de5" type="radio" <?php echo (get_data('status_de5')=='No')?'checked':''?> value="No">
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de6" class="de" name="status_de6" type="radio" <?php echo (get_data('status_de6')=='Yes')?'checked':''?> value="Yes" required="">
                                                                    <label for="status_de6">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de6" class="de" name="status_de6" type="radio" <?php echo (get_data('status_de6')=='No')?'checked':''?> value="No">
                                                        ...
                                                        <td data-title="Class of Equipment">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de7" class="de" name="status_de7" type="radio" <?php echo (get_data('status_de7')=='Yes')?'checked':''?> value="Yes" required="">
                                                                    <label for="status_de7">Yes</label>
                                                                </div>
                                                                <div class="radio-custom radio-info">
                                                                    <input id="de7" class="de" name="status_de7" type="radio" <?php echo (get_data('status_de7')=='No')?'checked':''?> value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="emp_den_license_yes" name="emp_den_license" type="radio" <?php echo (get_data('emp_den_license')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="emp_den_license_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="emp_den_license_no" name="emp_den_license" type="radio" <?php echo (get_data('emp_den_license')=='No')?'checked':''?> value="No">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="emp_license_per_yes" name="emp_license_per" type="radio" <?php echo (get_data('emp_license_per')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="emp_license_per_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="emp_license_per_no" name="emp_license_per" type="radio" <?php echo (get_data('emp_license_per')=='No')?'checked':''?> value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="emp_drug_test_status_yes" name="emp_drug_test_status" type="radio" <?php echo (get_data('emp_drug_test_status')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="emp_drug_test_status_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="emp_drug_test_status_no" name="emp_drug_test_status" type="radio" <?php echo (get_data('emp_drug_test_status')=='No')?'checked':''?> value="No">
                                            ...
                                            <tbody>
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_1')?>" id="work_date_1" name="work_date_1" required="">
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_2')?>" id="work_date_2" name="work_date_2" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker"  value="<?php echo get_data('work_date_3')?>" id="work_date_3" name="work_date_3" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_4')?>" id="work_date_4" name="work_date_4" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_5')?>" id="work_date_5" name="work_date_5" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_6')?>" id="work_date_6" name="work_date_6" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_7')?>" id="work_date_7" name="work_date_7" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_8')?>" id="work_date_8" name="work_date_8" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_9')?>" id="work_date_9" name="work_date_9" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_10')?>" id="work_date_10" name="work_date_10" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_11')?>" id="work_date_11" name="work_date_11" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_12')?>" id="work_date_12" name="work_date_12" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_13')?>" id="work_date_13" name="work_date_13" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                                                        ...
                                                        <td data-title="Date">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('work_date_14')?>" id="work_date_14" name="work_date_14" required="">
                                                            </div>
                                                        </td>
                                                        <td data-title="Hours Worked">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('emp_last_reliev_on')?>" id="emp_last_reliev_on" name="emp_last_reliev_on" required="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="w6-emp_profile" class="tab-pane">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="emp_curr_work_status_yes" name="emp_curr_work_status" type="radio" <?php echo (get_data('emp_curr_work_status')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="emp_curr_work_status_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="emp_curr_work_status_no" name="emp_curr_work_status" type="radio" <?php echo (get_data('emp_curr_work_status')=='No')?'checked':''?> value="No">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="radio-custom radio-info">
                                        <input id="emp_another_emply_status_yes" name="emp_another_emply_status" type="radio" <?php echo (get_data('emp_another_emply_status')=='Yes')?'checked':''?> value="Yes" required="">
                                        <label for="emp_another_emply_status_yes">Yes</label>
                                    </div>
                                    <div class="radio-custom radio-info">
                                        <input id="emp_another_emply_status_no" name="emp_another_emply_status" type="radio" <?php echo (get_data('emp_another_emply_status')=='No')?'checked':''?> value="No">
...
<?php 
    ...
    ?>
        ...
        if (val === "Yes") {
            if (ID === "de5" || ID === "de6" || ID === "de7") {
                ...
                $("#td_type_" + ID + "").html('<select class="form-control" name="type_' + ID + '" id="w6-type_' + ID + '" required><option value="" selected>Select Type</option><option value="Dump" '+"<?php echo (get_data('type_de'.($key+1))=='Dump')?'Selected':'';?>"+'>Dump</option><option value="Flat" <?php echo (get_data('type_de'.($key+1))=="Flat")?"Selected":"";?> >Flat</option><option  value="Reefer" <?php echo (get_data('type_de'.($key+1))=="Reefer")?"Selected":"";?> >Reefer</option><option value="Tank" <?php echo (get_data('type_de'.($key+1))=="Tank")?"Selected":"";?>>Tank</option><option value="Van" <?php echo (get_data('type_de'.($key+1))=="Van")?"Selected":"";?> >Van</option></select>');
            }
            $("#td_from_" + ID + "").html('<div class="input-group"><span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('from_de'.($key+1))?>"  id="from_' + ID + '" name="from_' + ID + '" required=""></div>');
            $("#td_to_" + ID + "").html('<div class="input-group"><span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_data('to_de'.($key+1))?>" id="to_' + ID + '" name="to_' + ID + '" required=""></div>');
    ...
    <?php if(get_data('prv_traffic_conviv_no') > 0 && get_data('prv_traffic_conviv_no') != ''): ?>
        $(function(){
