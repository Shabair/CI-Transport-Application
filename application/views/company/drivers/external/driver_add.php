...
<?php 
    ...
    // }else{
        $form_target = 'external/driver/add_driver';
    // }
    ...
    <div class="col-xs-12">
        <section class="panel form-wizard" id="w4">
        	<header class="panel-heading">
				<?php if($id == null){?>
                    <h4 class="head3" style="display:inline-block">Registration Form For <?php echo config_item('default_site_title')?></h4>
                <?php }?>
			</header>
            <div class="panel-body">
                ...
                <form class="form-horizontal" id="driver_add_form" action="<?php echo base_url($form_target)?>" method="post" novalidate enctype="multipart/form-data">
                    <div class="tab-content">
                        <input type="hidden" name="token" value="<?php echo get_data('token')?>">
                        <div id="w6-profile" class="tab-pane active">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="email" class="form-control" name="email" id="w6-email" value="<?php echo get_data('email');?>" autocomplete="off">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" value="<?php echo get_date_style(get_data('emp_license_org_date'));?>" id="emp_license_org_date" name="emp_license_org_date" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-plugin-datepicker="" class="form-control default-date-picker" id="emp_license_exp_date" value="<?php echo get_date_style(get_data('emp_license_exp_date'));?>" name="emp_license_exp_date" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control default-date-picker" id="w6-medical_due" value="<?php echo get_date_style(get_data('medical_due'));?>" name="medical_due" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <?php if(get_data('isFree') === 'True'){ ?>
        ...
        $("#driver_add_form input").each(function(){
            if(jQuery.inArray( $(this).attr('name'), requiredInputs ) == -1){
                ...
                if($(this).attr('value')=='___-___-___'){
