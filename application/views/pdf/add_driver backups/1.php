...
$pdf->TextInCenter('Advance Trucking Solution');
$pdf->ln(0);
...
$data = [
            ['Shabair Abdul','Driver','Any One','1/2/2017','signs'],
            ['Shabair Abdul','Driver','Any One','1/2/2017','signs'],
            ['Shabair Abdul','Driver','Any One','1/2/2017','signs'],
            ['Shabair Abdul','Driver','Any One','1/2/2017','signs'],
            ['Shabair Abdul','Driver','Any One','1/2/2017','signs'],
...
$arr = [
            [
                ['Driver\'s Name',$driver['firstname']],
                ['Phone #',$driver['phonenumber']]
            ],
            [
                ['Address',$driver['address']],
                ['Cellular #',$driver['callular']]
            ],
            [
                ['City',$driver['city']],
                ['Postal Code',$driver['postalcode']]
            ],
            [
                ['E-Mail',$driver['email']],
                ['','']
...
$pdf->SetFont('','',10);
$arr = [
        ['Applicant Name :',$driver['firstname'],'Date of Application :',date('m/d/Y',strtotime($driver['created_date']))]
];
$set = [28,86,33,36];
...
$arr =[
        ['City :',$company['city'],'State :',$company['state'],'Zip :',$company['postal_code']]
    ];
...
$arr=[
        ['Signature :','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','Date :',date('m/d/Y',strtotime($driver['created_date']))]
    ];
$set=[20,100,10,40];
$pdf->ln(2);
...
$pdf->ln(-1);
$arr = [
        ['APPLICANT HIRED','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','REGECTED','xxxxxxxxxxxxxxxxxxx'],
        ['DATE EMPLOYED','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','POINT EMPLOYED','xxxxxxxxxxxxxxxx'],
        ['DEPARTMENT','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','CLASSIFICATION','xxxxxxxxxxxxxx']
...
//$pdf->ln(2);
$arr = [
            ['SIGNATURE OF INTERVIEWING OFFICER','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']
        ];
$set=[67,112];
$pdf->SetFont('','',9);
...
$arr = [
            ['DATE TERMINATED','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','DEPARTMENT RELEASED FROM','xxxxxxxxxxxxxxxxxxxxxxxxxx']
];
$pdf->SetFont('','',9);
$set=[31,57,52,50];
...
$pdf->ln(0.8);
$arr=[
        ['DISMISSED','xxxxxxxxxxxxxxx','VOLUNTARILY QUIT','xxxxxxxxxxxxxx','OTHER','xxxxxxxxxxxx']
];
...
$pdf->ln(0.8);
$arr=[
        ['TERMINATION REPORT PLACED IN FILE','xxxxxxxxxxxxxxxxxx','SUPERVISOR','xxxxxxxxxxxxxxxxxxxxxxxxxxxxx']
];
$set=[63,45,25,57];
$pdf->ArrInCenter($arr,$set,[1,3,5],[],0.1);
...
$pdf->SetFont('','',9);
$text = 'In connection with your application for employment with <u><b>'.$company['name'].'</b></u> ("Prospective Employer"), Prospective Employer, its employees, agents or contractors may obtain one or more reports regarding your driving, and safety inspection history from the Federal Motor Carrier Safety Administration (FMCSA).';
...
$text = 'I authorize <u><b>'.$company['name'].'</b></u> ("Prospective Employer") to access the FMCSA Pre-Employment Screening Program (PSP)
...
$pdf->ln();
$arr=[
      ['The person designated by the company to answer driver\'s question is:','XXXXXXXXXXXXX']
...
$pdf->ln(25);
$arr=[
      ['xxxxx','',date('m/d/Y',strtotime($driver['created_date']))]
...
$arr=[
        ['Name',$driver['lastname'],$driver['firstname'],$driver['middlename'],'Social Security No.','XXXXXXXXXX']
];
...
$pdf->ln(5);
$arr=[
        ['Current Address',$driver['street'],$driver['city']]
];
$set =  [27,85,74];
$pdf->SetFont('','',9);
...
$arr=[
        ['',getstate($driver['province']),$driver['postalcode'],'Phone',$driver['phonenumber'],'How Long?',$driver['duration']]
];
...
$pdf->ln();
$pdf->MultiCell(190,5,$driver['emp_other_trk_exp'],'B');
...
$pdf->AddPage();
$pdf->SetFont('','B',14);
$pdf->Cell(190,5,"ADVANCE TRAINING SOLUTION",0,0,'C');
$pdf->ln(7);
...
$pdf->SetFont('','B',8);
$pdf->Cell(156,9,"KHURRAM SHEHZAD SHAHAB",0,0);
$pdf->ln(10);

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"DL # ","BL",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 111","BR",0,"C");

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"Company: ","B",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 112","BR",0,"C");
$pdf->ln();

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"To:  HR/Safety ","BL",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 222","BR",0,"C");

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"Attention: Safety","B",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 223","BR",0,"C");
$pdf->ln();

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"Tel: ","BL",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 333","BR",0,"C");

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"Fax: ","B",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 334","BR",0,"C");
$pdf->ln();

$pdf->SetFont('','',8);
$pdf->Cell(25,7,"Email: ","BL",0);
$pdf->SetFont('','B',8);
$pdf->Cell(70,7,"KHURRAM SHEHZAD SHAHAB 444","BR",0,"C");

$pdf->SetFont('','',8);
$pdf->Cell(55,7,"Pages (including cover sheet) ","B",0);
$pdf->SetFont('','B',8);
$pdf->Cell(40,7,"KHURRAM SHEHZAD SHAHAB 445","BR",0,"C");
$pdf->ln(15);



$companyName = "ADVANCE TRAINING SOLUTION";
$faxNo = "905-672-7138";
$text = "Dear Sir/Madam <br> We are authorized to obtain the verification record for the above mentioned driver on behalf of    <b><u>".$companyName."</u></b>    Could you please fill out the attached forms and return by fax @  <b>".$faxNo."</b>";
$pdf->SetFont('','',8);
$pdf->writeHTML($text);
$pdf->ln(10);
...
$pdf->SetFont('','',8.5);
$arr =[
        ['I (Print Name)','xxxxxxxxxxxxxx','','xxxxxxxxxxxxxxxx']
];
...
$pdf->ln(1);
$arr=[
        ['Hereby authorize:','xxxxxxxxxx']
    ];
$pdf->SetFont('','',8.5);
$set=[140,39];
$pdf->ArrInCenter($arr,$set,[1],[],0.1,3,3);
...
$arr=[
        ['Previous Employer:','xxxxxxxxxxxxxxxx','Email:','xxxxxxxxxx'],
        ['Street','xxxxxxxxxxxxxxxx','Telephone:','xxxxxxxxxx'],
        ['City,State,Zip:','xxxxxxxxxxxxxxxx','Fax No:','xxxxxxxxxx']
    ];
$pdf->SetFont('','',8.5);
$set=[27,98,17,42];
...
$pdf->Cell(50,4,"xxxxxxxxXXXXXX",'B');
...
$arr = [
        ['To','Prospective Employment:',$company['name']]
];
$pdf->SetFont('','',10);
$pdf->ln();
$set=[30,43,111];
$pdf->ArrInCenter($arr,$set,[2],[2],0.1,2,3);

$arr = [
        ['','Attention :','Safety & Compliance',' Telephone: ',$company['phone']]
];
$pdf->SetFont('','',10);
$pdf->ln();
$set=[30,43,54,21,36];
$pdf->ArrInCenter($arr,$set,[2,4],[2,4],0.1,2,3);

$arr = [
        ['','Street :',$company['physical_address']],
        ['','City,State,Zip:',$company['city'].', '.$company['state'].', '.$company['postal_code']]
];
$pdf->SetFont('','',10);
$pdf->ln();
$set=[30,43,54+21+36];
$pdf->ArrInCenter($arr,$set,[2],[2],0.1,5,4);
$pdf->SetFont('');
...
$pdf->SetFont('','B');
$pdf->Cell(60,4,"905 672 7138",'B',0,'C');

$pdf->SetFont('','');
$pdf->ln();
$pdf->Cell(63,5,"Prospective Employer's email address:");
$pdf->SetFont('','B');
$pdf->Cell(60,5,"ATS1@Live.Ca",'B',0,'C');

$pdf->ln();
$arr= [
        ['xxxxxxxxxxxxxxx','',date('m/d/Y',strtotime($driver['created_date']))]
];
$set=[100,5,70];
...
$pdf->ln(7);
$arr = [
            ['Employed as ','xxxxxxxxx',' from (m/y) ','xxxxxxxxxx','to(m/y)','XXXXXXXXX']
];
...
$pdf->Cell(157,5,$driver['firstname'].' '.$driver['middlename'].' '.$driver['lastname'],"B",0,'C');

$pdf->ln(8);
$pdf->Cell(40,5,'Social Security Number');
$pdf->Cell(148,5,$driver['social_sec_no'],"B",0,'C');

$pdf->ln(8);
$arr = [
        ['Driver\'s License:State',$driver['emp_license_state'],'Number',$driver['emp_license_no'],'Class',$driver['emp_license_class'],'Endorsement(s)',$driver['emp_license_endrosments'],'Restriction(s)',$driver['emp_license_restrictions']]
];
...
$pdf->ln(3);
$arr = [
        ['Type of license','','Issuing State',$driver['emp_license_state']]
];
...
$set=[30,10,10,10,10,10,10,10,10,10,10,10,10,10,10];
...
$pdf->MultiCell(21,5,"Total Hours ".$total_hours,1,'C');
...
$pdf->Cell(5);
$pdf->Cell(15,5,"1.     I,");
$pdf->Cell(95,5,$driver['firstname'].' '.$driver['middlename']." ".$driver['lastname'],'B',0,"C");
...
$pdf->ln(15);
$arr=[
      [$driver['witnessname'],'',date('m/d/Y',strtotime($driver['created_date']))]
...
$pdf->SetFont('');
$pdf->Cell(70,7,$company['name']);

$pdf->SetFont('','B',12);
$pdf->Cell(20,7,"TElE:");

$pdf->SetFont('');
$pdf->Cell(40,7,$company['phone']);
...
$pdf->SetFont('');
$pdf->Cell(70,7,$company['physical_address']);

$pdf->SetFont('','B',12);
$pdf->Cell(20,7,"FAX:");

$pdf->SetFont('');
$pdf->Cell(40,7,$company['fax']);
...
$pdf->SetFont('');
$pdf->Cell(70,7,$company['city'].', '.$comapny['state'].', '.$company['postal_code']);

$pdf->ln();
$pdf->ln();
$pdf->SetFont('','B',12);
$pdf->Cell(190,7,"DRIVER APPLICANT NAME: ".$driver['firstname'],1,0,'C');
$pdf->ln();
$pdf->Cell(190,7,"Social Security Number:".$driver['social_sec_no'],1,0,'C');
...
$pdf->Cell(155,8,$driver['firstname'],'B',0,'C');

$pdf->ln(10);
$pdf->Cell(48,8,'Social Security Number');
$pdf->Cell(137,8,$driver['social_sec_no'],'B',0,"C");

$pdf->ln(10);
$pdf->Cell(81,8,'Operator\'s or Chauffeur\'s License Number');
$pdf->Cell(104,8,$driver['emp_license_no'],'B');

$pdf->ln(10);
$pdf->Cell(12,8,'State');
$pdf->Cell(173,8,$driver['province'],'B');
...
$pdf->Cell(100,10,$driver['firstname'].' '.$driver['middlename'].' '.$driver['lastname'],'B',0,"C");
$pdf->Cell(20,10,'Phone','B');
$pdf->Cell(40,10,$driver['phonenumber'],'B',0,"C");

$pdf->ln(10);
$pdf->Cell(35,10,'Driver\'s Address','B');
$pdf->Cell(155,10,$driver['address'],'B',0,"C");

$pdf->ln(10);
$pdf->Cell(15,10,'City','B');
$pdf->Cell(62,10,$driver['city'],'B',0,"C");
$pdf->Cell(15,10,'State','B');
$pdf->Cell(38,10,$driver['street'],'B',0,"C");
$pdf->Cell(20,10,'Zip Code','B');
$pdf->Cell(40,10,$driver['postalcode'],'B',0,"C");
...
$pdf->AddPage();
$pdf->SetFont('','B',14);
$pdf->Cell(190,10,'Company Name: '.$company['name'],0,0,'C');
$pdf->ln();
$pdf->SetFont('','B',12);
$pdf->Cell(190,10,'Address: '.$company['physical_address'].', '.$company['city'].', '.$company['State'].', '.$company['postal_code'],0,0,'C');
...
$pdf->SetFont('','',12);
$pdf->Cell(5,8,'I,');
$pdf->Cell(110,8,$driver['firstname'].' '.$driver['middlename'].' '.$driver['lastname'],'B');
...
$pdf->Cell(65,8,$driver['witnessname'],'B',0,'C');
