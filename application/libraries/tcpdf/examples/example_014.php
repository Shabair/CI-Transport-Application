...
$pdf->TextField('first_name', 50, 5);
$pdf->Ln(6);

// Last name
$pdf->Cell(35, 5, 'Last name:');
$pdf->TextField('last_name', 50, 5);
$pdf->Ln(6);
...
function Print() {
	if(!CheckField('first_name','First name is mandatory')) {return;}
	if(!CheckField('last_name','Last name is mandatory')) {return;}
